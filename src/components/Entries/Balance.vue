<template>
    <div class="row q-mb-sm q-px-md q-py-sm shadow-up-3 items-center">
        ...
        <div :class="useAmountColorClass(storeEntries.balance)" class="col text-h6 text-right">
            <div class="row">
                <div class="col">
                    {{ useCurrencyFormatter(storeEntries.balance) }}
                </div>
            </div>
            <div class="row" v-if="storeEntries.balancePaid">
                <div class="col text-caption text-grey-6">
                   ...
                   <span
                      ...
                      {{ useCurrencyFormatter(storeEntries.balancePaid) }}
                    </span>
                </div>
            </div>
        </div>
